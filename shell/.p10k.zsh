# Generated by Powerlevel10k configuration wizard on 2022-11-24 at 16:51 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=66%
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 28 characters long, show it in full.
      # Otherwise show the first 10 … the last 10.
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 28 )) && branch[11,-11]="…"  # <-- this line
  ...
  # Remove everything after the first dot from the content of node_version.
